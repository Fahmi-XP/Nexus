...
<head>
    ...
    <link rel="stylesheet" href="Script/CSS/FrontEnd/C7-Wrong.css">
    ...
    <div class="warning-container">
        <div class="ln-box">
            <div class="login-header">
                <h2>Warning</h2>
                <a href="Z1-Login.php" class="close-button">×</a>
            </div>
            <div class="message">
            <?php
                if (isset($_GET['error'])) {
            ...
            <button type="submit" class="submit-button" onclick="location.href='Z1-Login.php';">Back</button>
            <div class="navigation-buttons">
                <a href="Z1-Login.php" class="button-left"><button>&lt;</button></a>
