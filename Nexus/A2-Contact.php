...
<head>
    ...
    <link rel="stylesheet" href="Script/CSS/BackEnd/C6-Contact.css">
</head>
<body>
<header>
...
<div class="container1">
    <div class="flex-container">
        <div class="about-us-text">Contact Us</div>
        <div class="powered-by-logo">
            <div class="powered-by">Powered By</div>
            <img src="/Nexus/Assets/Text/T1-PlaySafe.png" alt="Nexus Text" class="logo1">
        </div>
    </div>
</div>
...
<div class="container2">
    <div class="bottom-section">
        <div class="middle-section">
            <img src="/Nexus/Assets/Logo/L1-PlaySafe.png" alt="Nexus Logo" class="logo2">
            <div class="text-container">
                <img src="/Nexus/Assets/Text/T2-Nexus.png" alt="Playsafe Text" class="brand-name">
                <div class="copyright">© Nexus.com LTD</div> 
            </div>
        </div>
        <div class="divider"></div>
        <div class="right-section">
            <div class="download-title">Download Free Game</div>
            <div class="download-subtitle">Discover Your Next Adventure with Nexus</div>
        </div>
    </div>
</div>
...
<div class="container3">
    <div class="card">
        <div class="header">
            ...
            <a href="https://acesse.dev/rTpTS" class="text-white">
        ...
        <div class="footer-left">
            <div class="logo-text-container">
                ...
                <div class="text-container">
                    ...
                    <p class="text-sm">© Nexus.com LTD</p>
                </div>
            </div>
        </div>
...
<div class="footer2">
    <div class="footer2-container">
        <p class="text-xs">© 2024 Nexus. All rights reserved.</p>
